...
New authenticated agents can propose knowledge. The owner grants direct write access per token in **Settings → Tokens** (members are capped at `propose`); the claimed agent name never changes permissions.
